...
// render
    return (
       ...
       <View className='flex flex-row items-center bg-white/90 absolute px-3 py-1.5 rounded-full  top-5 rigth-5 ml-2 '>
...
export const Card = ({item: {image, rating, name, address, price}, onPress}: Props) => {
    // render
        return (
            <TouchableOpacity onPress={onPress} className="flex-1 w-full m-1  px-3 py-4 rounded-lg bg-white shadow-lg shadow-black-100/70 relative">
