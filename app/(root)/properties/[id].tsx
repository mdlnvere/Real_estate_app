...
const Property = () => {
    ...
    return (
            ...
            <ScrollView  className='bg-white h-full'>
                    <View className='relative w-full top-0' style={{ height: windowHeight / 2 }}>
                        <Image
              ...
              />
                ...
                <View className="mt-7">
                    ...
                    <View className='mt-4 flex flex-row items-center'>
                        <Image source={icons.location} className="size-4 mr-2" />
                        <Text className='text-base'>{property?.address}</Text>
                    </View>
